...
import '../stylesheets/TrendingNow.css';
...
function TrendingNow(){
    ...
    return(
        ...
        <div className="movieList">
            <div className="listTitle">Trending Today <ArrowForwardIosOutlinedIcon fontSize="small" className="arrow"/></div>
                ...
                <ArrowBackIosOutlinedIcon className="sliderArrow left" onClick ={()=>handleClick("left")} style={{display: !isMoved && "none"}}/>
                     <div className="movieContainer" ref = {listRef}>
                        {trendingMovies.map(mov =>(
                            ...
                            <div className="listItem" onMouseEnter={()=>selectMovie(mov)}>
